...
class MedianFinder {
    var leftMaxHeap: Heap<Int>
    var rightMinHeap: Heap<Int>

    init() {
        leftMaxHeap = Heap(comparator: { l, r in
            l > r
        })
        rightMinHeap = Heap(comparator: { l, r in
            l < r
        })
    }
    ...
    func addNum(_ num: Int) {
        ...
        if leftMaxHeap.count < rightMinHeap.count {
            leftMaxHeap.insert(item: rightMinHeap.popTop()!)
        }
    }
    ...
    func findMedian() -> Double {
        ...
        return Double(leftMaxHeap.getTop()!)
    }
}
